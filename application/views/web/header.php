              ...
              <nav class="c-mega-menu c-mega-menu-onepage c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold custom-menu-mobile" data-onepage-animation-speed="700">
                <ul class="nav navbar-nav c-theme-nav">
                  ...
                  <li class="<?php if($menu=='pengaduan' AND $sub_menu==''){echo "c-active ";} ?>c-menu-type-classic">
                    <a href="pengaduan" class="c-link dropdown-toggle">Pengaduan<span class="c-arrow c-toggler"></span></a>
                    <ul class="dropdown-menu c-menu-type-classic c-pull-left">
                      <li class="dropdown-submenu <?php if($menu=='pengaduan' AND $sub_menu=='cek'){echo "c-active ";} ?>">
                        <a href="pengaduan/cek" class="c-link">Tracking</a>
                      </li>
                    </ul>
                  </li>
