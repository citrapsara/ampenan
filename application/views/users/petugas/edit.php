            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="alamat" class="form-control" value="<?php echo $query->alamat; ?>" placeholder="Alamat" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-lg-3">No. Telp</label>
                    <div class="col-lg-9">
                      <input type="text" name="no_telp" class="form-control" value="<?php echo $query->no_telp; ?>" placeholder="No. Telp" onkeypress="return hanyaAngka(event);" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      ...
                      <i>*Password tidak wajib diisi.</i>
                    </div>
                  </div>
                  <div class="form-group">
