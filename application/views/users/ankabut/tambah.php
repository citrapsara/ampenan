            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="uraian" class="form-control" value="" placeholder="Nama File" required autofocus onfocus="this.value = this.value;">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-lg-3">File</label>
                    <div class="col-lg-9">
                      <input type="file" name="url_file" class="form-control" value="" placeholder="File Ankabut" required>
                    </div>
                  </div>
                  <hr>
