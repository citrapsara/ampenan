                  ...
                  <tbody>
                    <tr>
                      <tr>
                        ...
                        <th valign="top">:</th>
                        <td><?php echo ucfirst($revisi_dipa['id_user_verifikator_terakhir']); ?></td>
                      </tr>
                      <th valign="top" width="160">Status</th>
                      <th valign="top" width="1">:</th>
                      <td><?php 
                            if($verifikasi_usulan['status_verifikasi'] == 'sudah') { 
                              echo '<label class="label label-success">SUDAH DIVERIFIKASI</label>';
                            } elseif($verifikasi_usulan['status_verifikasi'] == 'tolak') {
                    ...
                    <tr>
                      ...
                      <th valign="top">:</th>
                      <td><?php echo ucfirst($verifikasi_usulan['komentar']); ?></td>
                    </tr>
                  </tbody>
                </table>
              </div>
