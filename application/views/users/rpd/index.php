                          ...
                          <?php if ($id_dipa == '00'): ?>
                            <div class="row">
                              <div class="col-md-12"><b>Filter</b></div>
                                ...
                                <div class="col-md-1">
                                  <button class="btn btn-default" onclick="window.location.href='rpd/v/'+$('#stt').val();"><i class="fa fa-search"></i> Filter</button>
                                </div>
                                <div class="col-md-6"></div>
                                <div class="col-md-2"></div>
                            </div>
                          <?php else: ?>
                            <a href="<?php echo strtolower($this->uri->segment(1)); ?>/<?php echo strtolower($this->uri->segment(2)); ?>/<?php echo $this->uri->segment(3); ?>/t.html" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Input RPD</a>
                            <a href="<?php echo strtolower($this->uri->segment(1)); ?>/<?php echo strtolower($this->uri->segment(2)); ?>/<?php echo $this->uri->segment(3); ?>/r.html" class="btn btn-primary"><i class="fa fa-pencil"></i> Revisi</a>
                            <?php endif; ?>
                            <hr>
