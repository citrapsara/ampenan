            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nama" class="form-control" value="" placeholder="Nama DIPA" required autofocus onfocus="this.value = this.value;">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="file" name="url_file_dipa" class="form-control" value="" placeholder="File DIPA" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-lg-3">File Lembar Kertas Kerja</label>
                    <div class="col-lg-9">
                      <input type="file" name="url_file_lkk" class="form-control" value="" placeholder="File Lembar Kertas Kerja" required>
                    </div>
                  </div>
                  <hr>
